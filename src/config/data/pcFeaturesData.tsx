...
import { PcFeaturesCard } from "../../homePage/components/featuresComponent/featuresCard";
import { FeaturesData } from "./featuresData";

export const PcFeaturesData = [
    {
        card: < div className="justify-center flex max-h-[840px]" >
    ...
    {
        card: <div className="justify-center flex gap-10">
